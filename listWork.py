...
# 4. Remove "apple" from fruits = ["apple", "orange", "grape"] using .remove().
fruits = ["apple","orange","grape"]
fruits.remove("apple")
print(fruits)

# 5. Use .pop() to remove the last element from colors = ["red", "blue", "green"].
colors = ["red", "blue", "green"]
colors.pop()
print(colors)

# 6. Replace the second element in animals = ["dog", "cat", "bird"] with "lion".
...
# 14. Remove all elements from data = [10, 20, 30] using .clear().
data = [10, 20, 30]
data.clear()
print(data)
